...
$__System.registerDynamic('6', ['3', '5'], true, function ($__require, exports, module) {
  /*!
...
$__System.registerDynamic('8', ['7'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
  module.exports = $__System._nodeRequire ? $__System._nodeRequire('buffer') : $__require('7');
});
...
$__System.registerDynamic('e', ['9', 'd'], true, function ($__require, exports, module) {
  /* */
  "format cjs";
      ...
      var histogram = function () {
        ...
        function histogram(data) {
          ...
          if (!Array.isArray(tz)) {
            ...
            tz = sequence(Math.ceil(x0 / tz) * tz, Math.floor(x1 / tz) * tz, tz);
          }
          var m = tz.length;
  ...
  })($__require('9').Buffer, $__require('d'));
});
...
$__System.register('1', ['11', 'f'], function (_export) {
    'use strict';

    var $, d3, reddit_url, gif_urls, gif_index;
    ...
    function drawVis(tree) {
        ...
        var svg = d3.select('body').append('div').style("width", width + 'px').style("height", height + 'px').style("border", "1px solid back").style('position', 'absolute').style('left', function (d) {
            return document.body.clientWidth / 2 - width / 2 + "px";
        ...
        var nodes = svg.selectAll('div').data(root.descendants()).enter().append('div')
        //.style("transform", function(d) { console.log(d.x); return "translate(" + d.x + "px," + d.y + "px)"; })
        .style('width', function (d) {
            return d.r * 2 + 'px';
        }).style('height', function (d) {
            return d.r * 2 + 'px';
        }).style('border-radius', '50%').style('border', '1px solid black').style('position', 'absolute').style('left', function (d) {
            return d.x - d.r + "px";
        }).style('top', function (d) {
            return d.y - d.r + "px";
        }).style('overflow', 'hidden').append('a').attr('href', function (d) {
            return d.data.url;
    ...
    return {
        ...
        execute: function () {
            reddit_url = 'https://www.reddit.com/r/perfectloops/top.json?sort=top&t=month';
            gif_urls = [];
            gif_index = 0;

            $.ajax(reddit_url).done(function (response) {

                var gifs = { children: [], score: 0 };

                gifs.children = response.data.children.filter(function (post) {
                ...
                gifs.children = gifs.children.filter(function (el) {
                    return el.url.endsWith('.gif');
                });
